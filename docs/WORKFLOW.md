...
5. **Partly done.** A two-clip FFmpeg join to exactly 30.000 s works (command in PRODUCTION.md). Still to do: captions, overlays, the 1080×1920 upscale, and a single `episode` command that verifies audio duration, captions, aspect ratio and the final playback. Store a manifest of models/assets used.
